...
class App {
            ...
            this.findTagetByTargetId(js.client.data.msg.targetid).then(r => {
                ...
                if (res.length) {
                    ...
                    let msg = {
                        ...
                        msgtype: js.client.data.msg.msgtype,
    ...
    checkUserPermission(username) {
        this.findUserByUsername(username).then((res) => {
            // console.log(res);
            if (res.length)
                return true;
            return false;
                                ...
                                db.destroy('_design/objectList', d._rev, (err, res) => {
                                    if (err)
                                        ...
                                        db.insert(design, "_design/objectList", (err, res) => {
                                            if (err)
                                                console.log('err insert new design ' + dbname + err);
                                            else {
